...
## Судьба текущего index.html

Статический `index.html` в корне — эталон вёрстки на время миграции.
После того как SPA достигает визуального паритета (проверка скриншотами),
файл удаляется из корня последним коммитом миграции.
